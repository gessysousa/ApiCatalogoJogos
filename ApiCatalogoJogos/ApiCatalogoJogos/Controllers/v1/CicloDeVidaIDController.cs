...
namespace ApiCatalogoJogos.Controllers.v1
{
    ...
    {
        public readonly IExemploSingleton _exemploSingleton1;//Singleton =>quando a aplicação sobe em memória, ele gera uma instancia desse recurso, ele pega essa instancia e vai ficar até o final do ciclo desse projeto. é como se fosse uma classe estática
        public readonly IExemploSingleton _exemploSingleton2;

        public readonly IExemploScoped _exemploScoped1; //scoped => ele é uma instancia que perdura durante toda a requisição. 
        public readonly IExemploScoped _exemploScoped2;

        public readonly IExemploTransient _exemploTransient1;//transient => pra cada vez que se injeta ele, ele te dá uma nova instancia.
    ...
    {
        public Guid Id { get; } //uma propriedade que não pode ser alterada
    }
